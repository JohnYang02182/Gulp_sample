$(function () {
  ...
  //recommend > copy qrcode
	...
	//safe_tab
	$(".tabZone01 .tab").click(function () {
		$(this).addClass("active").siblings().removeClass("active");
	}); 
	 $(".tabZone01 .tab").click(function(){
		var index = $(this).index();
		$(".subZone01").find(".safeList").eq(index).fadeIn(300).siblings().fadeOut(0);
	});

	//recommend_pageChange
	$(".goTAB02").click(function(){
		 $(".fundList01").css("display","none");
		 $(".fundList02").css("display","block");	
		 $(".fundList03").css("display","none");
		 $(".tab01").removeClass("active"); 
		 $(".tab02").addClass("active"); 
		 $(".tab03").removeClass("active"); 
	});
  $(".goTAB03").click(function(){
		 $(".fundList01").css("display","none");
		 $(".fundList02").css("display","none");	
		 $(".fundList03").css("display","block");
		 $(".tab01").removeClass("active"); 
